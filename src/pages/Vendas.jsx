      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogContent>
          <Typography variant="body2">
            Deseja atualizar os dados desta página? O processo leva aproximadamente <strong>5 minutos</strong>.
          </Typography>
        </DialogContent>
      ...
      {refreshing && (
        <Box sx={{ position: 'fixed', inset: 0, zIndex: 1400, background: 'rgba(0,0,0,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Card sx={{ p: 4, borderRadius: 3, boxShadow: 6, minWidth: 320, textAlign: 'center' }}>
            ...
            <Typography variant="body2" sx={{ mt: 1, color: 'text.secondary' }}>Isso pode levar até 5 minutos...</Typography>
          </Card>
        </Box>
      )}
    </Box>
